create or replace package PQ_CR_DATOS_ACUERDOS2 is


  -- ***************************************************************************************************************************
  -- Nombre                     : Paquete que devuleve los datos del acuerdo
  -- Sistema                    : BANTOTAL
...
end PQ_CR_DATOS_ACUERDOS2;
/

create or replace package body PQ_CR_DATOS_ACUERDOS2 is
