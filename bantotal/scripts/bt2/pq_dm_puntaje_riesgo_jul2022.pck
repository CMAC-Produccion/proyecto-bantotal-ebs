create or replace package PQ_DM_PUNTAJE_RIESGO_JUL2022 is
  ...
  Procedure SP_JOBS_PUNTAJE_RIESGO(PD_FECHA In Date);
  Procedure SP_OCUM_PUNTAJE_RIESGO(PV_FECPRO In Varchar2,
                                   PN_NIVRIE In Number,
                                   PN_GEOGRA In Number
                                  );

end PQ_DM_PUNTAJE_RIESGO_JUL2022;
/

create or replace package body PQ_DM_PUNTAJE_RIESGO_JUL2022 is
  ...
  Is
    ...
    ld_fecpro date := PD_FECHA;  --- ULTIMO DIA DE MES
  ...
  Begin
       ...
       For n in c_nivrie Loop
           For g in c_geogra Loop
               ln_job := ln_job + 1; 
               lv_nproc := 'Begin '||'PQ_DM_PUNTAJE_RIESGO_JUL2022.SP_OCUM_PUNTAJE_RIESGO('''||lv_Fecpro||
