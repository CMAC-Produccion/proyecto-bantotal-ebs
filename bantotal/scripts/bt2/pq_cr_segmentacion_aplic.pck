create or replace package PQ_CR_SEGMENTACION_APLIC is
...
end PQ_CR_SEGMENTACION_APLIC;
/

create or replace package body PQ_CR_SEGMENTACION_APLIC is
  ...
  begin
    ...
    pq_cr_segmentacion_aplic.Sp_cr_Resolutores(pn_pai,
                                               pn_tdo,
                                               pc_doc,
                                               pd_fecpro,
                                               pn_cal,
                                               ...
                                               lc_castigado,
                                               ln_CntAntRcc);
    pq_cr_segmentacion_aplic.Sp_Resolutores_NS(pn_pai,
                                               pn_tdo,
                                               pc_doc,
                                               pd_fecpro,
                                               ln_histCred,
    ...
    PQ_CR_SEGMENTACION_APLIC.sp_cr_NS_LINEA_APL(pd_fecpro,
                                                pn_pai,
                                                pn_tdo,
                                                pc_doc,
                                                pc_usr);
  ...
  BEGIN
    ...
    IF la_JAQZ082ndoc.count > 0 THEN
      FOR c IN la_JAQZ082ndoc.FIRST .. la_JAQZ082ndoc.LAST LOOP
        ...
        la_nomvar := la_nomnul;
        la_valvar := la_valnul;
        PQ_CR_SEGMENTACION_APLIC.sp_cr_cargar_variables_NS_APL(P_D_FECPRO => P_D_FECPRO,
  ...
  begin
    ...
    --mod20160705
    ---pn_doc := rpad(pc_ndo, 12, ' '); --mod@abr20180115
    ---   begin --mod@abr20180115
    --     select a.jaqy347ent --mod@abr20180115
    --       into ln_CntOpeRccTi --mod@abr20180115
    --       from jaqy347 a --mod@abr20180115
    --      where a.jaqy347pai = pn_pai --mod@abr20180115
    --        and a.jaqy347tdo = pn_tdo --mod@abr20180115
    --        and a.jaqy347ndo = pn_doc; --mod@abr20180115
    --   exception  --mod@abr20180115
    --     when others then --mod@abr20180115
    --       ln_CntOpeRccTi := 0; --mod@abr20180115
    --   end; --mod@abr20180115
    ...
    --mod20160705--mod@abr20180115
    --  pn_doc := rpad(lc_ndoC, 12, ' '); --mod@abr20180115
    --  begin --mod@abr20180115
    --    select a.jaqy347ent --mod@abr20180115
    --    into ln_CntOpeRccCy --mod@abr20180115
    --    from jaqy347 a --mod@abr20180115
    --   where a.jaqy347pai = ln_paiC --mod@abr20180115
    --     and a.jaqy347tdo = ln_tdoC --mod@abr20180115
    --     and a.jaqy347ndo = pn_doc; --mod@abr20180115
    --  exception  --mod@abr20180115
    --   when others then --mod@abr20180115
    --      ln_CntOpeRccCy := 0; --mod@abr20180115
