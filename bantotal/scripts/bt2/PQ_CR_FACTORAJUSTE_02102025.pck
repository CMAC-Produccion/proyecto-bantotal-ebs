...
create or replace package body PQ_CR_FACTORAJUSTE is
  ...
  begin
    ...
    /*se adiciona el porcentaje(score o convenio o antigüedad) + porcentaje desgravamen  + porcentaje consumo */
    pn_result := nvl(ln_result,0) + nvl(ln_resultdesg,0) + nvl(ln_resultcons,0);
