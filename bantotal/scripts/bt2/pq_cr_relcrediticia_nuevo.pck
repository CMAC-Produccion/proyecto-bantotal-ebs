create or replace package PQ_CR_RELCREDITICIA_NUEVO is
...
end PQ_CR_RELCREDITICIA_NUEVO;
/

create or replace package body PQ_CR_RELCREDITICIA_NUEVO is
      ...
      For i in creditos loop
        ...
        if ld_fecpago >= pd_fecor or ld_fecpago is null then
          ...
          if ld_fecantC <> i.ppfpag then
            ...
            ln_dias    := pq_cr_relcrediticia_nuevo.fn_cuotasPag(i.pgcod,
                                                           i.ppmod,
                                                           i.ppsuc,
                                                           i.ppmda,
                                                           i.pppap,
...
------------------------------------------------------------
  ...
  begin
    ...
    begin
      insert into jaqz081
        ...
        select B.PGCOD,
               ...
               b.aofval,
               b.aofvto,
               pq_cr_relcrediticia_nuevo.Fn_DiaPago(b.PGCOD,
                                              AOMOD,
                                              AOSUC,
                                              AOMDA,
                                              AOPAP,
    ...
    pq_cr_relcrediticia_nuevo.Sp_cr_histDiaAtr_linea(pn_pai,
                                               pn_tdo,
                                               pc_ndo,
                                               Pd_fecpro,
                                               ld_fecini,
  ...
  begin
    ...
    begin
      ...
      pq_cr_relcrediticia_nuevo.Sp_cr_histDiaAtr_linea_ii(pn_pai,
                                                    pn_tdo,
                                                    pc_ndo,
                                                    ld_feccorte,
                                                    pd_fecpro, /*pd_fecini,*/
  ...
  begin
    ...
    begin
      ...
      for i in creditos loop
        ...
        pq_cr_relcrediticia_nuevo.sp_calculaCuotas(i.pgcod,
                                             i.aomod,
                                             i.aosuc,
                                             i.aomda,
                                             i.aopap,
