...
BEGIN EXECUTABLE "JC_AUT_CONC_APEX" "JC"
  OWNER = "ORACLE12.2.10"
  LAST_UPDATE_DATE = "2025/06/06"
  EXECUTION_METHOD_CODE = "I"
  EXECUTION_FILE_NAME = "jc_conc_pkg.pr_ejec_conc_prog"
  USER_EXECUTABLE_NAME = "JC_AUT_CONC_APEX"
END EXECUTABLE

BEGIN DESC_FLEX "JC" "$SRS$.JC_AUT_CONC_APEX"
  OWNER = "ORACLE12.2.10"
  LAST_UPDATE_DATE = "2025/06/06 18:02:13"
  ...
  BEGIN DFF_CONTEXT "Global Data Elements"
    OWNER = "ORACLE12.2.10"
    LAST_UPDATE_DATE = "2025/06/06 17:57:58"
    ENABLED_FLAG = "Y"
    GLOBAL_FLAG = "Y"
...
BEGIN PROGRAM "JC_AUT_CONC_APEX" "JC"
  OWNER = "ORACLE12.2.10"
  LAST_UPDATE_DATE = "2025/06/06"
  USER_CONCURRENT_PROGRAM_NAME = "JC - Automatizacion Concurrentes APEX"
  EXEC = "JC_AUT_CONC_APEX" "JC"
  EXECUTION_METHOD_CODE = "I"
  ...
  SRS_FLEX = "JC" "$SRS$.JC_AUT_CONC_APEX"
  AUTO_ANNOTATION = "/**\n\
  */"
  RECALC_PARAMETERS = "N"
