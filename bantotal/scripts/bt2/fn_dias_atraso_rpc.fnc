create or replace function fn_dias_atraso_rpc(
  ...
  -- *****************************************************************
    ...
    -- Estado                     : Activo
    -- Acceso                     : Público
    -- Fecha Modificacion         : 2024.08.28 CALARCONAP - se duplicó función 'fn_dias_atraso' para obtener correctamente para caso de reprogramacion.
    -- *****************************************************************
        ...
        begin
          ...
          SELECT (v_Pgfape - min(a.Ppfpag))
           ...
           where a.Pgcod = v_Pgcod
             ...
             and a.D601co = 'S'
             and (a.ppcap + a.ppint) <> 0 --se agrego por cuotas de gracia 2013.09.06, --se cambio el mayor por diferente para casos negativos y positivos 
