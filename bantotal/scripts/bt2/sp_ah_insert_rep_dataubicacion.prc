CREATE OR REPLACE PROCEDURE "SP_AH_INSERT_REP_DATAUBICACION" is

	cursor dt_insercion is
...
BEGIN  
	for i in dt_insercion --TAPAZA: Recorre el cursor por i (fila) 
	...
	loop
     ...
     INSERT INTO JAQN74
    (JAQN74CODU, JAQN74UNI, JAQN74CSE, JAQN74SEDE, JAQN74CDEP, JAQN74DEP, JAQN74CAR, JAQN74ARE, JAQN74COS, JAQN74SEC, JAQN74CTR, JAQN74APP, JAQN74APM, JAQN74NOM, JAQN74DNI, JAQN74SEX, JAQN74FNAC, JAQN74FNM, JAQN74COR, JAQN74CPL, JAQN74PLA, JAQN74PTR, JAQN74FING, JAQN74FCES, JAQN74MOV, JAQN74SITU)
		VALUES(le_CODUNIDAD, la_UNIDAD, le_CODSEDE, ls_SEDE, le_CODDEPARTAMENTO, ld_DEPARTAMENTO, le_CODAREA , lr_AREA , le_CODSECCION, lh_SECCION, le_CODTRABAJADOR, lp_APEPAT, lp_APEMAT, lp_NOMBRE, li_DNI, lp_SEXO, lp_FECHANACIM, lp_FECNAC, lp_CORREO, le_CODPLANILLA, ll_PLANILLA, lc_PUESTRAB, le_FECHAINGRESO, le_FECHACESE, ln_MOTIVO, le_SITUACIONTRABAJADOR);
	end loop;
     commit;
	  ---***
    exception
...
end SP_AH_INSERT_REP_DATAUBICACION;
/
