create or replace package PQ_CR_RELACIONCREDITICIA2017 is
...
/*procedure sp_cr_relcre2017_job_mensual(P_D_FECPRO IN DATE);*/
 end PQ_CR_RELACIONCREDITICIA2017;
/

create or replace package body PQ_CR_RELACIONCREDITICIA2017 is
...
begin
      ...
      begin
          ...
          jaqz739AOPAP,jaqz739AOCTA,jaqz739AOOPER,jaqz739AOSBOP,jaqz739AOTOPE,jaqz739AOFVAL,
                    ...
                    select a.pgcod,
                           ...
                           a.aofval,
                           a.aofvto,
                           PQ_CR_RELACIONCREDITICIA2017.Fn_DiaPago(PGCOD,AOMOD,AOSUC,AOMDA,AOPAP,AOCTA,AOOPER,
                           ...
                           ' ',
                           --PQ_CR_RELACIONCREDITICIA2017.Fn_hipotecario(PGCOD,AOMOD,AOSUC,AOMDA,AOPAP,AOCTA,AOOPER,AOSBOP,AOTOPE)
     ...
     /* begin
       PQ_CR_RELACIONCREDITICIA2017.sp_cr_relacioncre2017_job(pd_fecpro);
      end;*/


      commit;

      --PQ_CR_RELACIONCREDITICIA2017.Sp_cr_Inserta(pd_fecpro,ld_fecini);
end Sp_carga_data;
--------------------------------------------------------------------------------------------
Function Fn_hipotecario(pn_emp in number,pn_mod in number,pn_suc in number,pn_mda in number,
                    pn_pap in number,pn_cta in number,pn_ope in number,pn_sbo in number,
...
flag:='S';
       ...
       exception
                     when others then null;
                          begin
                              select /*+index(FSD011 FSD01113)*/ 'N' INTO flag from fsd011 where fsd011.pgcod=pn_emp and 
      ...
      Begin
       ...
       --  pd_fecini:=ld_fecini;
         ...
         for i in creditos loop
             ln_contador := null;
             ln_inserta  := NULL;
             ln_ins := PQ_CR_RELACIONCREDITICIA2017.fn_inserta(i.jaqz740pepais,i.jaqz740petdoc,i.jaqz740pendoc,ln_anio,ln_mes);

             if ln_ins = 0 then
                --pq_cr_relcrediticia.sp_cr_cancelados(i.pepais,i.petdoc,i.pendoc,pd_fecpro,ln_inserta,
                --                                     ld_feccan);
                --if ln_inserta = 'S' then
                    PQ_CR_RELACIONCREDITICIA2017.Sp_cr_historial(i.jaqz740pepais,i.jaqz740petdoc,i.jaqz740pendoc,pd_fecini,pd_fecpro,
                                                        ln_contador,
...
begin
     ...
     begin
      ...
      JAQZ735AOOPER,JAQZ735AOSBOP,JAQZ735AOTOPE,JAQZ735AOFVAL,JAQZ735AOFVTO,JAQZ735AOFE99,JAQZ735AOSTAT,JAQZ735PEPAIS,JAQZ735PETDOC,JAQZ735PENDOC) 
          ...
          select a.pgcod,
                 ...
                 a.aofvto,
                 --a.aofe99,
                 PQ_CR_RELACIONCREDITICIA2017.Fn_DiaPago(a.PGCOD,AOMOD,AOSUC,AOMDA,AOPAP,AOCTA,AOOPER,
                 ...
                 /* Case 
                  ...
                  PQ_CR_RELACIONCREDITICIA2017.Fn_hipotecario(PGCOD,AOMOD,AOSUC,AOMDA,AOPAP,AOCTA,AOOPER,AOSBOP,AOTOPE)                        
                    ...
                    PQ_CR_RELACIONCREDITICIA2017.Fn_hipotecario(a.PGCOD,a.AOMOD,a.AOSUC,a.AOMDA,a.AOPAP,a.AOCTA,a.AOOPER,a.AOSBOP,a.AOTOPE,NVL(fn_instancia_credito( a.PGCOD ,
                                                   a.AOSUC ,
                                                   a.AOMDA ,
                                                   a.AOPAP ,
                                                   a.AOCTA ,
     ...
     PQ_CR_RELACIONCREDITICIA2017.Sp_cr_InsNuevo(pn_pais,pn_tdo,pc_ndo,pd_fecpro,ld_fecini,ln_contador);
...
begin
      ...
      Begin
         ...
         for i in creditos loop
             ln_contador := null;
             PQ_CR_RELACIONCREDITICIA2017.Sp_cr_histNuevo(i.jaqz735pepais,i.JAQZ735petdoc,i.JAQZ735pendoc,pd_fecini,pd_fecpro,
                                                 ln_contador);
   ...
   begin
    ...
    For i in creditos loop
      ...
      if ln_sw = 0 then
        ...
        ld_aofe99 := last_day(i.JAQZ735aofe99);
...
--      PQ_CR_RELACIONCREDITICIA2017.Sp_cr_Inserta_MENSUAL(pd_fecpro,ld_fecini);
      ...
      Begin
         ...
         for i in creditos loop
             ...
             if ln_ins = 0 then
                ...
                --                                     ld_feccan);
                --if ln_inserta = 'S' then
                     PQ_CR_RELACIONCREDITICIA2017.Sp_cr_historial(i.jaqz740pepais,i.jaqz740petdoc,i.jaqz740pendoc,ld_fecini,pd_fecpro,
                                                        ln_contPro,
...
procedure sp_cr_relacioncre2017_job(P_D_FECPRO IN DATE) is
     ...
     group by substr(trim(j.jaqz739aocta), -1, 1); 
      ...
      lc_variable varchar2(1000);
       ln_job number:=0;
      ln_inst number(1):=1;--cambio de 1 a 2  new 2 a 1 01/01/2024
      ln_cont number(5):=0;
      begin
        begin
          select host_name
           ...
           for job in c_relacioncre2017_job loop
              --lc_variable := ' begin '||
              --'PQ_CR_RELACIONCREDITICIA2017.sp_cr_relacioncre2017('''||job.digito||''');'||
              --                                                                   ' End; ';
           lc_variable := ' begin '|| ' PQ_CR_RELACIONCREDITICIA2017.sp_cr_relacioncre2017('||''''||job.digito||'''' ||');'|| ' End; ';
            ln_cont := ln_cont +1;
...
procedure sp_cr_relacioncre2017(digito varchar2) is
   ...
   begin
     ...
     update jaqz739 
     set jaqz739.jaqz739hipo=trim(PQ_CR_RELACIONCREDITICIA2017.Fn_hipotecario(
