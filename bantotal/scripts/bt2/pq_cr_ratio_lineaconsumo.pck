create or replace package PQ_CR_RATIO_LINEACONSUMO is

  -- Author  : MPOSTIGOC--
  -- Created : 18/10/17 12:46:54 p.m.
  -- Purpose : Ratio en Disposicion de lineas consumo.
  ...
  procedure sp_resolutor_venc(ln_Pepais  in number,
                              ...
                              ln_garant    in varchar2, --ccerpa 27/09/2018                                                                  
                              ln_segmen    in number, --ccerpa 27/09/2018
                              lc_Usuario   in varchar2, ----- piratas diferencia
                              ln_capacidad out number);
  -----------------------------------------------------------
...
end PQ_CR_RATIO_LINEACONSUMO;
/

create or replace package body PQ_CR_RATIO_LINEACONSUMO is
                ...
                where dscod = 50
                  and modulo not in ((select tp1nro1
                                      ...
                                      where a.tp1cod = 1
                                        ...
                                        and a.tp1corr1 = 200
                                        and a.tp1corr2 = 3
                                        and a.tp1corr3 > 0)))) --Agregar guia de proceso para excluir modulos
         and b.aostat <> 99
                  ...
                  and f.modulo not in
                      ((select tp1nro1
                        ...
                        where a.tp1cod = 1
                          ...
                          and a.tp1corr1 = 200
                          and a.tp1corr2 = 3
                          and a.tp1corr3 > 0))) or x.xwfmodulo = 117)
  ...
  begin
    ...
    begin
      ...
      select 'S' into lc_flgprg from dual;
    exception
      when others then
        lc_flgprg := 'N';
    ...
    for i in inserta loop
      ...
      PQ_CR_RATIO_LINEACONSUMO.sp_refinanLinea(i.ln_pgcod10,
                                               i.ln_mod10,
                                               i.ln_suc10,
                                               i.ln_mda10,
                                               i.ln_pap10,
      ...
      PQ_CR_RATIO_LINEACONSUMO.Sp_Adicional_CK(i.ln_mod10,
                                               i.ln_tope10,
                                               lc_fgAdic);
      PQ_CR_RATIO_LINEACONSUMO.Sp_ampliados_CK(i.ln_pgcod10,
                                               i.ln_mod10,
                                               i.ln_suc10,
                                               i.ln_mda10,
                                               i.ln_pap10,
      ...
      if lc_fgAdic <> 'S' and lc_fgAmpl <> 'S' and lc_fgRefLin <> 'S' and
        ...
        PQ_CR_RATIO_LINEACONSUMO.sp_resolutor(ln_Pepais,
                                              ln_Petdoc,
                                              ln_Pendoc,
                                              Instancia,
                                              pd_fecpro,
    ...
    for c in vuelo loop
      ...
      PQ_CR_RATIO_LINEACONSUMO.Sp_Adicional_CK(c.ln_mod10,
                                               c.ln_tope10,
                                               lc_fgAdic);
    ...
    for j in lineas_ven loop
      ...
      PQ_CR_RATIO_LINEACONSUMO.Sp_Adicional_CK(j.ln_mod10,
                                               j.ln_tope10,
                                               lc_fgAdic);
    
      PQ_CR_RATIO_LINEACONSUMO.sp_refinanLinea(J.ln_pgcod10,
                                               J.ln_mod10,
                                               J.ln_suc10,
                                               J.ln_mda10,
                                               J.ln_pap10,
      ...
      if lc_ven = 'S' then
        pq_cr_ratio_lineaconsumo.sp_cr_VerfLVInsertada(ln_instancia  => Instancia,
                                                       lc_Estado     => 'I',
                                                       ln_pgcod117   => 1,
      ...
      if lc_ven = 'S' and lc_IsInsert = 'N' and lc_fgAdic <> 'S' and
        ...
        PQ_CR_RATIO_LINEACONSUMO.sp_resolutor_venc(ln_Pepais,
                                                   ln_Petdoc,
                                                   ln_Pendoc,
                                                   Instancia,
                                                   pd_fecpro,
    ...
    begin
      ...
      /*begin
        pq_cr_hipotecario_vehicular.sp_cr_eva_excedente(pn_instancia => Instancia,
                                                        pn_mtoexc    => ln_ExcdntMensual);
      end;*/
    ...
    if lc_flgprg = 'S' or lc_flgprg = 'R' then
      ...
      /* PQ_CR_RATIO_LINEACONSUMO.sp_cr_LogRatio(ln_Pepais        => ln_Pepais,
                                                    ln_Petdoc        => ln_Petdoc,
                                                    ln_Pendoc        => ln_Pendoc,
  ...
  begin
    ...
    PQ_CR_RATIO_LINEACONSUMO.sp_cuotas(ln_pgcod10,
                                       ln_mod10,
                                       ln_suc10,
                                       ln_mda10,
                                       ln_pap10,
    ...
    PQ_CR_RATIO_LINEACONSUMO.sp_instancia(ln_mod10,
                                          ln_suc10,
                                          ln_mda10,
                                          ln_pap10,
                                          ln_cta10,
    ...
    PQ_CR_RATIO_LINEACONSUMO.sp_cr_flujocaja(ln_pgcod10,
                                             ln_mod10,
                                             ln_suc10,
                                             ln_mda10,
                                             ln_pap10,
    ...
    if ln_mod10 <> 117 and ln_flagFC = 'N' then
      if ln_indicador <> 2 then
        PQ_CR_RATIO_LINEACONSUMO.sp_cuota_impaga(ln_pgcod10,
                                                 ln_mod10,
                                                 ln_suc10,
                                                 ln_mda10,
                                                 ln_pap10,
        ...
        PQ_CR_RATIO_LINEACONSUMO.sp_cuota_impagavuelo(ln_pgcod10,
                                                      ln_mod10,
                                                      ln_suc10,
                                                      ln_mda10,
                                                      ln_pap10,
      ...
      if ln_mod10 <> 117 and ln_flagFC = 'S' then
        PQ_CR_RATIO_LINEACONSUMO.sp_cr_capacidadFC(ln_mod10,
                                                   ln_suc10,
                                                   ln_mda10,
                                                   ln_pap10,
                                                   ln_cta10,
    ...
    PQ_CR_RATIO_LINEACONSUMO.sp_seguro(ln_mod10,
                                       ln_suc10,
                                       ln_mda10,
                                       ln_pap10,
                                       ln_cta10,
    ...
    if ln_mod10 = 117 then
      PQ_CR_RATIO_LINEACONSUMO.sp_capacidadlinea(ln_mod10,
                                                 ln_suc10,
                                                 ln_mda10,
                                                 ln_pap10,
                                                 ln_cta10,
    ...
    IF ln_parciales = 7 then
      ...
      PQ_CR_RATIO_LINEACONSUMO.sp_capacidadpagoparc(ln_nrocuotas,
                                                    ln_parciales,
                                                    ln_seguro,
                                                    ln_mod10,
                                                    ln_instancia,
    ...
    if ln_mod10 <> 117 and ln_parciales <> 7 then
      ...
      PQ_CR_RATIO_LINEACONSUMO.sp_capacidadpago(ln_cuotimp,
                                                ln_nrocuotas,
                                                ln_parciales,
                                                ln_peri10,
                                                ln_seguro,
    ...
    if lc_flgprg = 'S' or lc_flgprg = 'R' then
      ...
      if ln_capacidad > 0 then
        ...
        PQ_CR_RATIO_LINEACONSUMO.sp_cr_LogCuentas(ln_Pepais,
                                                  ln_Petdoc,
                                                  ln_Pendoc,
                                                  tipocambio,
                                                  Instancia,
  ...
  begin
    ...
    if lc_ven = 'S' then
      for i in creditos loop
        ...
        PQ_CR_RATIO_LINEACONSUMO.sp_cuotas(i.ln_pgcod10,
                                           i.ln_mod10,
                                           i.ln_suc10,
                                           i.ln_mda10,
                                           i.ln_pap10,
        ...
        PQ_CR_RATIO_LINEACONSUMO.sp_cuota_impaga_lin(i.ln_pgcod10,
                                                     i.ln_mod10,
                                                     i.ln_suc10,
                                                     i.ln_mda10,
                                                     i.ln_pap10,
        ...
        PQ_CR_RATIO_LINEACONSUMO.sp_seguro(i.ln_mod10,
                                           i.ln_suc10,
                                           i.ln_mda10,
                                           i.ln_pap10,
                                           i.ln_cta10,
                                           ...
                                           fech_maxcuota,
                                           ln_seguro);
        PQ_CR_RATIO_LINEACONSUMO.sp_capacidadpago_lin(ln_cuotimp,
                                                      ln_nrocuotas,
                                                      ln_pr116,
                                                      ln_seguro,
                                                      i.ln_mod10,
                                                      ln_capTem);
        PQ_CR_RATIO_LINEACONSUMO.sp_instancia(i.ln_mod10,
                                              i.ln_suc10,
                                              i.ln_mda10,
                                              i.ln_pap10,
                                              i.ln_cta10,
