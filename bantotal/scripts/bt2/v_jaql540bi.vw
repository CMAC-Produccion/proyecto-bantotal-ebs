create or replace force view v_jaql540bi as
...
b.z0e478thp,b.z0e478tht,b.z0e478thd,
--decode(b.z0e478thd,null,null,substr(trim(b.z0e478thd),0,length(trim(b.z0e478thd))-4)||'****') z0e478thd,
