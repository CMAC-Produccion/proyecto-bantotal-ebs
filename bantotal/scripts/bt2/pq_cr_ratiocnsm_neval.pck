create or replace package PQ_CR_RATIOCNSM_NEVAL is

  -- Author  : MPOSTIGOC
  -- Created : 18/10/17 12:46:54 p.m.
  -- Purpose :Ratio en Reprogramaciones Consumo
...
end PQ_CR_RATIOCNSM_NEVAL;
/

create or replace package body PQ_CR_RATIOCNSM_NEVAL is
  ...
  begin
    ...
    for i in inserta loop
      ...
      PQ_CR_RATIOCNSM_NEVAL.sp_refinanLinea(i.ln_pgcod10,
                                            i.ln_mod10,
                                            i.ln_suc10,
                                            i.ln_mda10,
                                            i.ln_pap10,
      ...
      PQ_CR_RATIOCNSM_NEVAL.Sp_Adicional_CK(i.ln_mod10,
                                            i.ln_tope10,
                                            lc_fgAdic);
    
      PQ_CR_RATIOCNSM_NEVAL.Sp_ampliados_CK(i.ln_pgcod10,
                                            i.ln_mod10,
                                            i.ln_suc10,
                                            i.ln_mda10,
                                            i.ln_pap10,
      ...
      if lc_fgAdic <> 'S' and lc_fgAmpl <> 'S' and lc_fgRefLin <> 'S' and
        ...
        PQ_CR_RATIOCNSM_NEVAL.sp_resolutor(ln_Pepais,
                                           ln_Petdoc,
                                           ln_Pendoc,
                                           Instancia,
                                           pd_fecpro,
    ...
    for c in vuelo loop
      ...
      PQ_CR_RATIOCNSM_NEVAL.Sp_Adicional_CK(c.ln_mod10,
                                            c.ln_tope10,
                                            lc_fgAdic);
    ...
    for j in lineas_ven loop
      ...
      PQ_CR_RATIOCNSM_NEVAL.Sp_Adicional_CK(j.ln_mod10,
                                            j.ln_tope10,
                                            lc_fgAdic);
    
      PQ_CR_RATIOCNSM_NEVAL.sp_refinanLinea(J.ln_pgcod10,
                                            J.ln_mod10,
                                            J.ln_suc10,
                                            J.ln_mda10,
                                            J.ln_pap10,
      ...
      if lc_ven = 'S' then
        pq_cr_ratiocnsm_neval.sp_cr_VerfLVInsertada(ln_instancia  => Instancia,
                                                    lc_Estado     => 'H',
                                                    ln_pgcod117   => 1,
                                                    ...
                                                    lc_RegInst116 => lc_VerfInst);
      
      end if;
    
      if lc_ven = 'S' and lc_VerfInst = 'N' and lc_fgAdic <> 'S' and
         lc_fgRefLin <> 'S' and lc_FlgLn <> 'S' then
      
        PQ_CR_RATIOCNSM_NEVAL.sp_resolutor_venc(ln_Pepais,
                                                ln_Petdoc,
                                                ln_Pendoc,
                                                Instancia,
                                                pd_fecpro,
           ...
           and (j.jaqz822mod not in
               (select tp1nro1
                  ...
                  where a.tp1cod = 1
                    ...
                    and a.tp1corr1 = 200
                    and a.tp1corr2 = 1
                    and a.tp1corr3 > 0) and j.jaqz822mod not in 117)
    ...
    begin
      ...
      PQ_CR_RATIOCNSM_NEVAL.sp_cr_CuotaContinCF(Instancia,
                                                pd_fecpro,
                                                lc_flgprg,
                                                ln_MntCuoCntgCF);
    
      PQ_CR_RATIOCNSM_NEVAL.sp_cr_CuotaContinAval(Instancia,
                                                  pd_fecpro,
                                                  lc_flgprg,
                                                  ln_MntCuoCntgAval);
    ...
    if ln_MntPotncial = 9999 then
      ...
      begin
        ...
        begin
          ...
          update aqpb357 j
             set j.aqpb357aux3 = ''
           where j.aqpb357inst = Instancia;
          --  and j.aqpb357aux1 = 7; --Tarea de Evaluacion Propuesta
          commit;
        end;
        ...
        begin
          select sum(j.aqpb357gfin)
            into saldo_extSoles
            from aqpb357 j
           where j.aqpb357inst = Instancia
             and j.aqpb357esta = 'S'
             and j.aqpb357chek = '1'
             and j.aqpb357tcre in
                 ('Pymes S/.', 'Consumo S/.', 'Hipotecario S/.')
             and j.aqpb357aux3 = 'R'; --MPOSTIGOC 04/10/18 INC1373
          --  and j.aqpb357aux1 = 7; --MPOSTIGOC 04/10/18 INC1373
        exception
          when others then
            saldo_extSoles := 0;
        end;
    ...
    PQ_CR_RATIOCNSM_NEVAL.sp_cr_LogRatio(ln_Pepais        => ln_Pepais,
                                         ln_Petdoc        => ln_Petdoc,
                                         ln_Pendoc        => ln_Pendoc,
    ...
    if ln_pais is not null then
      ...
      for l in lista_CredVigCF(ln_pais, ln_tdoc, lc_ndoc) loop
        ...
        if ln_SaldCap > 0 then
          begin
            PQ_CR_RATIOCNSM_NEVAL.sp_cr_LogCuentas(ln_pais,
                                                   ln_tdoc,
                                                   lc_ndoc,
                                                   ln_tipocambio,
                                                   ln_Instancia,
  ...
  begin
    ...
    if ln_pais is not null then
      ...
      for l in lista_CredVigAval(ln_pais, ln_tdoc, lc_ndoc) loop
        ...
        PQ_CR_RATIOCNSM_NEVAL.Sp_ampliados_CK(ln_emp10  => l.ln_pgcod10,
                                              ln_mod10  => l.ln_mod10,
                                              ln_suc10  => l.ln_suc10,
                                              ln_mda10  => l.ln_mda10,
                                              ln_pap10  => l.ln_pap10,
        ...
        PQ_CR_RATIOCNSM_NEVAL.sp_refinanLinea(ln_pgcod10  => l.ln_pgcod10,
                                              ln_mod10    => l.ln_mod10,
                                              ln_suc10    => l.ln_suc10,
                                              ln_mda10    => l.ln_mda10,
                                              ln_pap10    => l.ln_pap10,
      ...
      for l in lista_CredVigAval(ln_paiscy, ln_tdoccy, lc_ndoccy) loop
        ...
        begin
          select count(*)
            into ln_EsConsd
            from jaqz822b j
           where j.jaqz822pgcod = l.ln_pgcod10
             and j.jaqz822mod = l.ln_mod10
             and j.jaqz822suc = l.ln_suc10
             and j.jaqz822mda = l.ln_mda10
             and j.jaqz822pap = l.ln_pap10
             and j.jaqz822cta = l.ln_cta10
             and j.jaqz822ope = l.ln_oper10
             and j.jaqz822sbop = l.ln_sbop10
             and j.jaqz822tope = l.ln_tope10
             and j.jaqz822inst = ln_Instancia
             and j.jaqz822est = 'H';
        exception
          when others then
            null;
  ...
  begin
    ...
    PQ_CR_RATIOCNSM_NEVAL.sp_cuotas(ln_pgcod10,
                                    ln_mod10,
                                    ln_suc10,
                                    ln_mda10,
                                    ln_pap10,
    ...
    PQ_CR_RATIOCNSM_NEVAL.sp_instancia(ln_mod10,
                                       ln_suc10,
                                       ln_mda10,
                                       ln_pap10,
                                       ln_cta10,
    ...
    PQ_CR_RATIOCNSM_NEVAL.sp_cr_flujocaja(ln_pgcod10,
                                          ln_mod10,
                                          ln_suc10,
                                          ln_mda10,
                                          ln_pap10,
    ...
    if ln_mod10 <> 117 and ln_flagFC = 'N' then
      if ln_indicador <> 2 then
        PQ_CR_RATIOCNSM_NEVAL.sp_cuota_impaga(ln_pgcod10,
                                              ln_mod10,
                                              ln_suc10,
                                              ln_mda10,
                                              ln_pap10,
        ...
        PQ_CR_RATIOCNSM_NEVAL.sp_cuota_impagavuelo(ln_pgcod10,
                                                   ln_mod10,
                                                   ln_suc10,
                                                   ln_mda10,
                                                   ln_pap10,
      ...
      if ln_mod10 <> 117 and ln_flagFC = 'S' then
        PQ_CR_RATIOCNSM_NEVAL.sp_cr_capacidadFC(ln_mod10,
                                                ln_suc10,
                                                ln_mda10,
                                                ln_pap10,
                                                ln_cta10,
    ...
    PQ_CR_RATIOCNSM_NEVAL.sp_seguro(ln_mod10,
                                    ln_suc10,
                                    ln_mda10,
                                    ln_pap10,
                                    ln_cta10,
    ...
    if ln_mod10 = 117 then
      PQ_CR_RATIOCNSM_NEVAL.sp_capacidadlinea(ln_mod10,
                                              ln_suc10,
                                              ln_mda10,
                                              ln_pap10,
                                              ln_cta10,
    ...
    IF ln_parciales = 7 then
      ...
      PQ_CR_RATIOCNSM_NEVAL.sp_capacidadpagoparc(ln_nrocuotas,
                                                 ln_parciales,
                                                 ln_seguro,
                                                 ln_mod10,
                                                 ln_instancia,
    ...
    if ln_mod10 <> 117 and ln_parciales <> 7 then
      ...
      PQ_CR_RATIOCNSM_NEVAL.sp_capacidadpago(ln_cuotimp,
                                             ln_nrocuotas,
                                             ln_parciales,
                                             ln_peri10,
                                             ln_seguro,
    ...
    if ln_capacidad > 0 then
      ...
      PQ_CR_RATIOCNSM_NEVAL.sp_cr_LogCuentas(ln_Pepais,
                                             ln_Petdoc,
                                             ln_Pendoc,
                                             tipocambio,
                                             Instancia,
  ...
  begin
    ...
    if lc_ven = 'S' then
      for i in creditos loop
        ...
        PQ_CR_RATIOCNSM_NEVAL.sp_cuotas(i.ln_pgcod10,
                                        i.ln_mod10,
                                        i.ln_suc10,
                                        i.ln_mda10,
                                        i.ln_pap10,
        ...
        PQ_CR_RATIOCNSM_NEVAL.sp_cuota_impaga_lin(i.ln_pgcod10,
                                                  i.ln_mod10,
                                                  i.ln_suc10,
                                                  i.ln_mda10,
                                                  i.ln_pap10,
        ...
        PQ_CR_RATIOCNSM_NEVAL.sp_seguro(i.ln_mod10,
                                        i.ln_suc10,
                                        i.ln_mda10,
                                        i.ln_pap10,
                                        i.ln_cta10,
                                        ...
                                        fech_maxcuota,
                                        ln_seguro);
        PQ_CR_RATIOCNSM_NEVAL.sp_capacidadpago_lin(ln_cuotimp,
                                                   ln_nrocuotas,
                                                   ln_pr116,
                                                   ln_seguro,
                                                   i.ln_mod10,
                                                   ln_capTem);
        PQ_CR_RATIOCNSM_NEVAL.sp_instancia(i.ln_mod10,
                                           i.ln_suc10,
                                           i.ln_mda10,
                                           i.ln_pap10,
                                           i.ln_cta10,
