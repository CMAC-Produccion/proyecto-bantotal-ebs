create or replace package "PQ_CR_RESOLUTOR_SEG_DESEMPLEO" is
  ...
  Procedure Cobros_SegDESAGRI_NEW(pd_fechaini in date,
                                  pd_fechafin in date,
                                  pn_tipo     in number,
                                  pc_users    in varchar2);
...
create or replace package body "PQ_CR_RESOLUTOR_SEG_DESEMPLEO" is
  ...
  -- Modificacion: SMARQUEZ 07/08/2025 Adición de proceso  Cobros_segdesagri_New
  Procedure Sp_seg_desempleo(pn_ins in number,
                             pn_tip out number,
...
--               and j6.jaqm66hor = f5.hhora;
  ...
  fecha date;
  fechaini date;
  Cursor AGricolaDiario (fecha1 in date) is
           select pn_tipo tipo,
                  fecha1 fecha,
                  f6.ctnro cuenta,
                  'SEG.AGRICOLA' producto,
                  (select lpad(c.xwfcuenta,9,'0')||lpad(c.xwfoperacion,9,'0')
                    from jaqm66 a , jaqm65 b, xwf700 c
                   where b.jaqm65ins = a.jaqm66ins
                     and b.jaqm65ac1 = 'C'
                     and a.jaqm66ins = j6.jaqm66ins
                     and c.xwfprcins = b.jaqm65ins
                     and c.xwfcar3 = '1')nrocertificado,
                  f6.itimp1 monto,
                  (SELECT SCNOM FROM FST001 where sucurs =  f5.itsuc) sucursal,
                  (select (select jaqm64cod||'-'||trim(jaqm64des) from  jaqm64 where jaqm64tad = 1 and jaqm64cod = b1.jaqm65cod)
                     from jaqm66 a1 , jaqm65 b1
                    where b1.jaqm65ins = a1.jaqm66ins
                      and a1.jaqm66ins = j6.jaqm66ins
                      and b1.jaqm65ac1 = 'C') motivo,
                  'Soles' moneda,
                  (select penom from fsd001 where pepais =604 and petdoc= 21 and  pendoc = (select pendoc from fsr008 where ctnro = f6.ctnro and ttcod= 1 and cttfir = 'T')) nombre,
                  (select pendoc from fsr008 where ctnro = f6.ctnro and ttcod= 1 and cttfir = 'T') documento,
                  pc_users usuario,
                  (select a1.jaqm66imp
                           from jaqm66 a1 , jaqm65 b1
                          where b1.jaqm65ins = a1.jaqm66ins
                            and b1.jaqm65ac1 = 'C'
                            and a1.jaqm66ins = j6.jaqm66ins) monto2,
                 (select a1.jaqm66fea
                           from jaqm66 a1 , jaqm65 b1
                          where b1.jaqm65ins = a1.jaqm66ins
                            and b1.jaqm65ac1 = 'C'
                            and a1.jaqm66ins = j6.jaqm66ins) fechaAfi,
                  f5.itsuc CodigoSUC,
                 (select sng001ase from sng001 where sng001inst = j6.jaqm66ins) Asesor,
                 (select ( select WFUSRNAME from WFUSERS WHERE WFUSRCOD = sng001ase )
                    from sng001 where sng001inst = j6.jaqm66ins) DescAsesor,
                 (select XWFFEC1 from xwf700 where xwfprcins =  j6.jaqm66ins AND XWFCAR3 ='1') fechavto,
                 j6.jaqm66ins instancia
            from fsd015 f5,
                 fsd016 f6,
                 jaqm66 j6
           where f5.pgcod = 1
             ...
             and f5.ittran = 440
             and f5.itsuc = 11
             and f5.itfcon  = fecha1 --pfecha ---- la fecha es del domingo pues el proceso se corre el primer domingo --en todo caso `08/08/2021¿ ya estare de vuelta
             and f5.itcorr  = 0
             and f5.itcont = 'S'
             and f6.pgcod = f5.pgcod
             and f6.itmod = f5.itmod
  ...
  cursor historicoAgri (fechai in date) is
         select pn_tipo tipo ,
                F5.HFCON fecha,
                f6.hcta cuenta,
                'SEG.AGRICOLA' producto,
                (select (lpad(c.xwfcuenta,9,'0')||lpad(c.xwfoperacion,9,'0'))
                  ...
                  where b.jaqm65ins = a.jaqm66ins
                   ...
                   and c.xwfcar3 = '1') nrocertificado,
                f6.hcimp1 monto,
                (SELECT SCNOM FROM FST001 where sucurs =  f5.hsucor) sucursal,
                (select (select jaqm64cod||'-'||trim(jaqm64des) from  jaqm64 where jaqm64tad = 1 and jaqm64cod = b1.jaqm65cod)
                   from jaqm66 a1 , jaqm65 b1
                  where b1.jaqm65ins = a1.jaqm66ins
                    and a1.jaqm66ins = j6.jaqm66ins
                    and b1.jaqm65ac1 = 'C') motivo,
                'Soles' moneda,
                (select penom from fsd001 where pepais =604 and petdoc= 21 and  pendoc = (select pendoc from fsr008 where ctnro = f6.hcta and ttcod= 1 and cttfir = 'T')) nombre,
                (select pendoc from fsr008 where ctnro = f6.hcta and ttcod= 1 and cttfir = 'T' ) documento,
                pc_users usuario,
                (select a1.jaqm66imp
                   from jaqm66 a1 , jaqm65 b1
                  where b1.jaqm65ins = a1.jaqm66ins
                    and a1.jaqm66ins = j6.jaqm66ins
                    and b1.jaqm65ac1 = 'C') monto2,
                (select a1.jaqm66fea
                   from jaqm66 a1 , jaqm65 b1
                  where b1.jaqm65ins = a1.jaqm66ins
                    and a1.jaqm66ins = j6.jaqm66ins
                    and b1.jaqm65ac1 = 'C') fechaAfi,
                 f5.hsucor codigosucor,
                 (select sng001ase from sng001 where sng001inst = j6.jaqm66ins) Asesor,
                 (select ( select WFUSRNAME from WFUSERS WHERE WFUSRCOD = sng001ase )
                    from sng001 where sng001inst = j6.jaqm66ins) descasesor,
                 (select XWFFEC1 from xwf700 where xwfprcins =  j6.jaqm66ins AND XWFCAR3 ='1') fechavto,
     ...
     where f5.pgcod = 1
       ...
       and f5.hsucor = 11
       and f5.htran = 440
       and f5.hfcon  = fechai ---- la fecha es del domingo pues el proceso se corre el primer domingo --en todo caso `08/08/2021¿ ya estare de vuelta
       and f5.hccorr = 0
       and f6.pgcod = f5.pgcod
       and f6.hcmod = f5.hcmod
       and f6.hsucor = f5.hsucor
  ...
  cursor desempleodiario (fechai in date) is
  select pn_tipo tipo,
                  fechai fechapro,
                  f6.ctnro cuenta ,
                  'SEG.DESEMPLEO' producto,
                  (select lpad(c.xwfcuenta,9,'0')||lpad(c.xwfoperacion,9,'0')
                    from jaqm66 a , jaqm65 b, xwf700 c
                   where b.jaqm65ins = a.jaqm66ins
                     and b.jaqm65ac1 = 'C'
           ...
           where f5.pgcod = 1
             ...
             and f5.ittran = 441
             and f5.itsuc = 11
             and f5.itfcon  = fechai --pfecha ---- la fecha es del domingo pues el proceso se corre el primer domingo --en todo caso `08/08/2021¿ ya estare de vuelta
             and f5.itcorr  = 0
             and f5.itcont = 'S'
             and f6.pgcod = f5.pgcod
             and f6.itmod = f5.itmod
             ...
             and j6.jaqm66ime = f6.itimp1
             and substr(j6.jaqm66hor,1,5) =  substr(f5.ithora,1,5);
    cursor desempleohistorico (fechai in date) is
    select pn_tipo tipo,
                        F5.HFCON fecha,
                        f6.hcta cuenta,
                        'SEG.DESEMPLEO' producto,
  ...
  -- WHERE AQPA560COD = pn_tipo and aqpa560a4 = pc_users;
   commit;
    ...
    if pn_tipo = 1 then -- Agricola
      if pd_fechafin = fecha then
        for a in AGricolaDiario(fecha) loop
            begin
               INSERT INTO AQPA560 (aqpa560cod,
                                    aqpa560fec,
                                    aqpa560cta,
        ...
        while fechaini <= pd_fechafin loop
          for b in historicoAgri(fechaini) loop
              Begin
                 INSERT INTO AQPA560 (aqpa560cod,
                                    aqpa560fec,
                                    aqpa560cta,
      ...
      -- Aqui para Desempleo cambia el rubro
      if pd_fechafin = fecha then
        for a in desempleodiario(fecha) loop
            begin
               INSERT INTO AQPA560 (aqpa560cod,
                                    aqpa560fec,
                                    aqpa560cta,
        ...
        while fechaini <= pd_fechafin loop
          For b in desempleohistorico(fechaini) loop
            Begin
               INSERT INTO AQPA560 (aqpa560cod,
                                  aqpa560fec,
                                  aqpa560cta,
