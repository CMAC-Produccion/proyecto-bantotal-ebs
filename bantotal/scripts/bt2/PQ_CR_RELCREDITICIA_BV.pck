create or replace package PQ_CR_RELCREDITICIA_BV is

      -- *****************************************************************
    -- Nombre                     : PQ_CR_RELCREDITICIA_BV
    -- Sistema                    : BANTOTAL
    -- Módulo                     : Créditos - Activas
    -- Versión                    : 1.0
    -- Fecha de Creación          : 05/01/2026
    -- Autor de Creación          : DCASTRO
    -- Uso                        : Basado en paquete PQ_CR_RELCREDITICIA_A - YYAMPIprocesos de calculo de relacion creditica para ampliaciones
    -- Estado                     : Activo
    -- Acceso                     : Público
    -- Fecha Modificacion         : 
    -- ***************************************************************** 
  ...
  end PQ_CR_RELCREDITICIA_BV;
/
create or replace package body PQ_CR_RELCREDITICIA_BV is
  ...
  begin
    ...
    delete from AQPD905 a
     where a.AQPD905PAIS = pn_pais
       and a.AQPD905TDOC = pn_tdo
       and a.AQPD905NDOC = pc_ndo;
    commit;
      ...
      insert into AQPD905
        ...
        select pgcod,
          ...
          from (select a.pgcod,
                       ...
                       a.aofvto,
                       --a.aofe99,
                       PQ_CR_RELCREDITICIA_BV.Fn_DiaPago(a.PGCOD,
                                                      AOMOD,
                                                      AOSUC,
                                                      AOMDA,
                                                      AOPAP,
                 ...
                 where b.pgcod = 1
                   ...
                   and (aofe99 >= ld_fecini or
                       ...
                       --)
                  and (aomod, aotope) in ( select TP1NRO1, TP1NRO2 ---Producto bienvenidos
                                              from fst198
                                             where tp1cod = 1
                                               and tp1cod1 = 10899 
                                               and tp1corr1 = 9
    ...
    PQ_CR_RELCREDITICIA_BV.Sp_cr_InsNuevo(pn_pais,
                                       pn_tdo,
                                       pc_ndo,
                                       pd_fecpro,
                                       ld_fecini,
...
-------------------------------------------------------------------------------------------------
  Procedure Sp_cr_InsNuevo(pn_pais     in number,
    ...
    -- ****************************************************************
    cursor creditos is
      select a.aqpd905pais pepais, a.aqpd905tdoc petdoc, a.aqpd905ndoc pendoc
        from AQPD905 a
       where a.aqpd905pais = pn_pais
         and a.aqpd905tdoc = pn_tdo
         and a.aqpd905ndoc = pc_ndo;
  ...
  begin
    ...
    Begin
      ...
      for i in creditos loop
        ln_contador := null;
        PQ_CR_RELCREDITICIA_BV.Sp_cr_histNuevo(i.pepais,
                                            i.petdoc,
                                            i.pendoc,
                                            pd_fecini,
                                            pd_fecpro,
  ...
  Procedure Sp_cr_histNuevo(pn_pai      in number,
    ...
    cursor creditos is
      select aqpd905cod, 
              ...
              aqpd905ndoc
        from AQPD905 a
       where a.aqpd905pais = pn_pai
         and a.aqpd905tdoc = pn_tdo
         and a.aqpd905ndoc = pc_ndo
       order by a.aqpd905fval;
