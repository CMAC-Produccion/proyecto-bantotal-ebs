CREATE OR REPLACE PROCEDURE SP_AH_REP_RECLAMOS_CLACAN_SC(P_USER IN VARCHAR, P_CLACOD IN NUMBER
...
, P_ERRMSG        OUT VARCHAR
  ...
  ---***
  ---******
  FOR MROW IN (SELECT * FROM JAQL422C WHERE JAQL422CEST = 'S' AND JAQL422CSBS BETWEEN ln_MIN_CLACOD AND ln_MAX_CLACOD)
  LOOP
  ---***
  ln_INSERT := 0;
  lc_CLADES := 0;
  ...
  FOR XROW IN
  ((SELECT J420.JAQL420COD, J422C.JAQL422CDES, J422C.JAQL422CCOD, J422C.JAQL422CSBS, J420.JAQL420FCR, J420.JAQL420ESR
  , J420.JAQL420FCC, J420.JAQL420FLD
  FROM JAQL420 J420
  JOIN JAQL422C J422C ON (J420.JAQL420CAN = J422C.JAQL422CCOD AND J422C.JAQL422CEST = 'S')
  WHERE J422C.JAQL422CSBS = MROW.JAQL422CSBS
  ...
  INSERT INTO AQPB521 (AQPB521CREUSR, AQPB521CRETIM, AQPB521REPTIP, AQPB521CODIGO
    ...
    VALUES (P_USER, SYSDATE, 'C',  MROW.JAQL422CSBS
...
---******
END SP_AH_REP_RECLAMOS_CLACAN_SC;
/
