create or replace package PQ_CR_REPROGRAMACIONES_RPC is

  -- *****************************************************************
  -- Nombre                     : PQ_CR_REPROGRAMACIONES_RPC
  -- Purpose                    : copia de paquete PQ_CR_REPROGRAMACIONES_RPC para regla de negocio
  -- Sistema                    : BANTOTAL
  -- Módulo                     : Créditos - Activas
  -- Versión                    : 1.0
  -- Fecha de Creación          : 13/09/2024 10:30:13
...
end PQ_CR_REPROGRAMACIONES_RPC;
/

create or replace package body PQ_CR_REPROGRAMACIONES_RPC is
