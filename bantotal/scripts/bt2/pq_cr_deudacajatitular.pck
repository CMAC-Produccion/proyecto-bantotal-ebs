create or replace package PQ_CR_Deudacajatitular is
  ...
  -- Descripción de Modificación: Se cambi el tamaño de las variables numericas.
  --
  -- * *************************************************************************************************************/
...
end PQ_CR_Deudacajatitular;
/

create or replace package body PQ_CR_Deudacajatitular is
  ...
  begin
    ...
    if lc_prgm = 'PASIVO' then
      PQ_CR_Deudacajatitular.sp_cuentasPasivo(ln_Pepais,
                                              ln_Petdoc,
                                              ln_Pendoc,
                                              Instancia,
                                              ln_PasivoCorrSol,
      ...
      if lc_prgm <> 'PASIVO' then
        ...
        PQ_CR_Deudacajatitular.sp_cuentasRatio(ln_Pepais,
                                               ln_Petdoc,
                                               ln_Pendoc,
                                               tipocambio,
                                               Instancia,
                  ...
                  and modulo not in
                      ((select fst198.tp1nro1
                        ...
                        where fst198.tp1cod = 1
                          ...
                          and fst198.tp1corr2 = 3))) or d10.Aomod in (141))
         and d10.Aostat <> 99
      union
  ...
  begin
    ...
    for i in inserta loop
      ...
      PQ_CR_Deudacajatitular.sp_refinanLinea(i.ln_pgcod10,
                                             i.ln_mod10,
                                             i.ln_suc10,
                                             i.ln_mda10,
                                             i.ln_pap10,
      ...
      PQ_CR_Deudacajatitular.Sp_ampliados_CK(i.ln_pgcod10,
                                             i.ln_mod10,
                                             i.ln_suc10,
                                             i.ln_mda10,
                                             i.ln_pap10,
      ...
      PQ_CR_Deudacajatitular.sp_cr_Reprogramados(i.ln_pgcod10,
                                                 i.ln_mod10,
                                                 i.ln_suc10,
                                                 i.ln_mda10,
                                                 i.ln_pap10,
      ...
      if lc_fgRefLin <> 'S' and lc_fgAmpl <> 'S' AND lc_fgRepro <> 'S' then
        PQ_CR_Deudacajatitular.sp_resolutor(ln_Pepais,
                                            ln_Petdoc,
                                            ln_Pendoc,
                                            tipocambio,
                                            Instancia,
    ...
    for l in linea loop
      ...
      PQ_CR_Deudacajatitular.sp_refinanLinea(l.ln_pgcod10,
                                             l.ln_mod10,
                                             l.ln_suc10,
                                             l.ln_mda10,
                                             l.ln_pap10,
    ...
    for c in vuelo loop
      ...
      PQ_CR_Deudacajatitular.sp_resolutorvuelo(ln_Pepais,
                                               ln_Petdoc,
                                               ln_Pendoc,
                                               tipocambio,
                                               Instancia,
    ...
    for j in lineas_ven loop
      ...
      PQ_CR_Deudacajatitular.sp_refinanLinea(j.ln_pgcod10,
                                             j.ln_mod10,
                                             j.ln_suc10,
                                             j.ln_mda10,
                                             j.ln_pap10,
      ...
      if lc_ven = 'S' and lc_fgRefLin <> 'S' and lc_FlgLn <> 'S' then
        PQ_CR_Deudacajatitular.sp_resolutor_venc(ln_Pepais,
                                                 ln_Petdoc,
                                                 ln_Pendoc,
                                                 tipocambio,
                                                 Instancia,
    ...
    if lc_flgprg = 'S' or lc_flgprg = 'R' then
      ...
      PQ_CR_Deudacajatitular.sp_cr_LogRatio(ln_Pepais,
                                            ln_Petdoc,
                                            ln_Pendoc,
                                            tipocambio,
                                            Instancia,
  ...
  begin
    ...
    for i in inserta loop
      ...
      if lc_fgRefLin <> 'S' and lc_fgAmpl <> 'S' AND lc_fgRepro <> 'S' then
        PQ_CR_Deudacajatitular.sp_resolutorpasivo(ln_Pepais,
                                                  ln_Petdoc,
                                                  ln_Pendoc,
                                                  Instancia,
                                                  pd_fecpro,
    ...
    for c in vuelo loop
      ...
      PQ_CR_Deudacajatitular.sp_resolutorvueloPasivo(ln_Pepais,
                                                     ln_Petdoc,
                                                     ln_Pendoc,
                                                     Instancia,
                                                     pd_fecpro,
    ...
    for j in lineas_ven(pd_fecpro) loop
      ...
      if lc_ven = 'S' and lc_fgRefLin <> 'S' and lc_FlgLn <> 'S' then
        PQ_CR_Deudacajatitular.sp_resolutor_vencPasivo(ln_Pepais,
                                                       ln_Petdoc,
                                                       ln_Pendoc,
                                                       Instancia,
                                                       pd_fecpro,
    ...
    PQ_CR_Deudacajatitular.sp_cr_LogPasivo(ln_Pepais,
                                           ln_Petdoc,
                                           ln_Pendoc,
                                           Instancia,
                                           pd_fecpro,
  ...
  begin
    ...
    If lc_fgRefLin <> 'S' then
      ...
      PQ_CR_Deudacajatitular.sp_cr_saldocapital(ln_pgcod10,
                                                ln_mod10,
                                                ln_suc10,
                                                ln_mda10,
                                                ln_pap10,
      ...
      if lc_fgRefLin = 'S' then
        ...
        PQ_CR_Deudacajatitular.sp_cr_saldocapitalref(tipocambio,
                                                     Instancia,
                                                     ln_saldocap);
    ...
    if (lc_flgprg = 'S' or lc_flgprg = 'R') and ln_saldocap > 0 then
      ...
      PQ_CR_Deudacajatitular.sp_cr_LogCuentas(ln_Pepais,
                                              ln_Petdoc,
                                              ln_Pendoc,
                                              tipocambio,
                                              Instancia,
  ...
  begin
    ...
    if lc_ven = 'S' then
      for i in creditos loop
        ...
        PQ_CR_Deudacajatitular.sp_cr_saldocapital(i.ln_pgcod10,
                                                  i.ln_mod10,
                                                  i.ln_suc10,
                                                  i.ln_mda10,
                                                  i.ln_pap10,
  ...
  begin
    ...
    If lc_fgRefLin <> 'S' then
      ...
      PQ_CR_Deudacajatitular.sp_cr_SaldCapPasivo(ln_pgcod10,
                                                 ln_mod10,
                                                 ln_suc10,
                                                 ln_mda10,
                                                 ln_pap10,
      ...
      if lc_fgRefLin = 'S' then
        ...
        PQ_CR_Deudacajatitular.sp_cr_saldocapitalref(Instancia,
                                                     ln_MontSolAux,
                                                     ln_MontDolAux);
    ...
    if ln_MontSolAux > 0 or ln_MontDolAux > 0 then
      ...
      PQ_CR_Deudacajatitular.sp_cr_LogCtaPasivo(ln_Pepais,
                                                ln_Petdoc,
                                                ln_Pendoc,
  ...
  begin
    ...
    If lc_fgRefLin <> 'S' then
      ...
      if lc_fgRefLin = 'S' then
        ...
        PQ_CR_Deudacajatitular.sp_cr_SaldCapRefPas( --tipocambio,
                                                   ln_InstVerif,
                                                   ln_MontSolAux,
                                                   ln_MontDolAux);
  ...
  begin
    ...
    if lc_ven = 'S' then
      for i in creditos loop
        ...
        PQ_CR_Deudacajatitular.sp_cr_SaldCapPasivo(i.ln_pgcod10,
                                                   i.ln_mod10,
                                                   i.ln_suc10,
                                                   i.ln_mda10,
                                                   i.ln_pap10,
