create or replace package pq_cr_reporte_fondos_p2 is
  -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
...
procedure sp_distribuc_pago_tot(pn_cod   in number,
  ...
  -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --   
  end pq_cr_reporte_fondos_p2;
/

create or replace package body pq_cr_reporte_fondos_p2 is
  -- Obtener Fecha de vencimiento de última cuota impaga  
      ...
      begin
        select trim(t.c_codsbs),
         ...
         where t.d_fecpre = lc_fecha_pro
           and t.c_tdocid =
               pq_cr_reporte_fondos_p2.FN_EQUIVALENCIADOC(pn_tdoc)
  ...
  procedure sp_obtener_datos_ufecha(pn_cod   in number,
                                    ...
                                    pn_fvenu out date) is   -- Fecha de vencimiento de la última cuota pagada
  ...
  begin
    ...
    if lx_cont > 0 then
      ...
      if pn_tabla = 'AQPB002' or pn_tabla = 'JAQZ698' then
        begin
          -- Call the procedure
          pq_cr_reporte_fondos_p2.sp_repro_dato2(pn_cod   => pn_cod,
                                                 pn_cta   => pn_cta,
                                                 pn_ope   => pn_ope,
                                                 pn_frep  => pn_fech,
                                                 pn_tabla => pn_tabla,
  ...
  begin
    ...
    begin
      pq_cr_reporte_fondos_p2.sp_cr_datoscre(pn_cta => pn_cta,
                                             pn_ope => pn_ope,
                                             pn_emp => ln_pgcod,
                                             pn_mod => ln_mod,
                                             pn_suc => ln_suc,
    ...
    case
      when pn_tabla = 'AQPB002' then
        ...
        if lx_exis = 0 and lx_vali = 1 then
          ...
          begin
            -- Call the procedure
            pq_cr_reporte_fondos_p2.sp_insertar_detalle_grupo1(pn_frep   => lc_frep,
                                                               pn_corr   => lc_corr,
                                                               pn_pgcod  => pn_cod,
                                                               pn_aomod  => lx_mod,
                                                               pn_aosuc  => lx_suc,
          ...
          begin
            -- Call the procedure
            pq_cr_reporte_fondos_p2.sp_insertar_detalle_grupo2(pn_frep   => lc_frep,
                                                               pn_corr   => lc_corr,
                                                               pn_pgcod  => pn_cod,
                                                               pn_aomod  => lx_mod,
                                                               pn_aosuc  => lx_suc,
          ...
          begin
            -- Call the procedure
            pq_cr_reporte_fondos_p2.sp_insertar_detalle_grupo3(pn_frep   => lc_frep,
                                                               pn_corr   => lc_corr,
                                                               pn_pgcod  => pn_cod,
                                                               pn_aomod  => lx_mod,
                                                               pn_aosuc  => lx_suc,
      ...
      when pn_tabla = 'JAQZ698' then
        ...
        if lx_exis = 0 and lx_vali = 1 then
          ...
          begin
            -- Call the procedure
            pq_cr_reporte_fondos_p2.sp_repro_jaqz698_g1(pn_frep   => lc_frep,
                                                        pn_corr   => lc_corr,
                                                        pn_pgcod  => pn_cod,
                                                        pn_aomod  => lx_mod,
                                                        pn_aosuc  => lx_suc,
          ...
          begin
            -- Call the procedure
            pq_cr_reporte_fondos_p2.sp_repro_jaqz698_g2(pn_frep   => lc_frep,
                                                        pn_corr   => lc_corr,
                                                        pn_pgcod  => pn_cod,
                                                        pn_aomod  => lx_mod,
                                                        pn_aosuc  => lx_suc,
  ...
  begin
    ...
    begin
      ...
      lx_inst_sol := fn_instancia_credito(v_scmod  => pn_mod,
                                          v_scsuc  => pn_suc,
                                          v_scmda  => pn_mda,
                                          v_scpap  => pn_pap,
                                          v_sccta  => pn_cta,
      ...
      /*
      select 
           sum(t.sng023mto) into lx_sum
      from sng023 t 
      where t.sng021eval=lx_inst 
      and t.sng026cod in (38,39,538,539);       
      */
      ...
      /*
      select sum((case
                   when s.SNG026COD in (538, 539) then
                    u.sng120tcbi
                   else
                    1
                 end) * s.sng023mto)
        ...
        from SNG023 s, sng120 u
       where u.sng120ins = lx_inst_sol
         and s.SNG026COD IN (38, 39, 538, 539)
         and u.SNG120TSK = 'EVALUACION'
         and s.sng021eval = lx_inst;
         */
  ...
  begin
    ...
    begin
      -- Call the function
      pn_ufech := pq_cr_reporte_fondos_p2.fn_fecha_upago(pn_cod   => pn_cod,
                                                         pn_mod   => pn_mod,
                                                         pn_suc   => pn_suc,
                                                         pn_mda   => pn_mda,
                                                         pn_pap   => pn_pap,
