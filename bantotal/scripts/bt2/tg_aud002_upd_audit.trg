CREATE OR REPLACE TRIGGER "TG_AUD002_UPD_AUDIT"
  BEFORE UPDATE ON "BANTPROD"."AUD002"
  FOR EACH ROW
DECLARE
...
BEGIN
  ...
  sys.sp_sy_enviamail('ehidalgom@cajaarequipa.pe',
                                       ...
                                       'Auditoría Actualizada en Bantotal para '||:old.audtblnam || ' ' ||sys_context('USERENV', 'DB_NAME')||' HOST '||V_HOSTNAME,
