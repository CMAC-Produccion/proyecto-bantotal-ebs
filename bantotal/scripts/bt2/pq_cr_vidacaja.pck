create or replace package PQ_CR_VIDACAJA is
  ...
  -----------------------------
  procedure sp_cr_Desafiliaciones(pd_fecpro  in date,
                                  P_C_DIGITO in varchar2);

  --------------------------------------------------------
  procedure sp_cr_Desafilia60(P_C_DIGITO in varchar2, ld_fecfin in date);
  ---------------
...
create or replace package body PQ_CR_VIDACAJA is
  -- *****************************************************************
  -- Nombre                     : PQ_CR_VIDACAJA
  -- Sistema                    : BANTOTAL
  -- Módulo                     : Créditos - Activas
      ...
      insert into jaqz085_aux
        ...
        select g.pgcod,
         ...
         where g.pgcod = 1
           ...
           and h.sgcod in ( select TP1NRO3 from  Fst198
                             Where Tp1cod   = 1
                               and Tp1cod1  = 10898
                               and TP1CORR1 = 18
                               and tp1corr3 = 1)--(116, 117, 118, 119, 120, 121, 122)
        --  and g.aocta = 1758411
         group by g.pgcod,
                  g.aomod,
                  g.aosuc,
  ...
  Procedure Sp_monto_calendarioVC(pn_emp      in number,
    ...
    cursor seguros is
      select sgcod tp1nro1
        from fst300
       where sgcod in ( select TP1NRO3 from  Fst198
                             Where Tp1cod   = 1
                               and Tp1cod1  = 10898
                               and TP1CORR1 = 18
                               and tp1corr3 = 1);--- (116, 117, 118, 119, 120, 121, 122);
      ...
      for i in seguros loop
        ...
        if ln_codVar <> 0 then
          ...
          begin
            ...
            begin
              select a.pp001imp
               ...
               where a.pgcod = pn_emp
                 ...
                 and a.aosbop = pn_sbo
                 and a.aotope = pn_top
                 and a.sgcod in ( select TP1NRO3 from  Fst198
                                   Where Tp1cod   = 1
                                     and Tp1cod1  = 10898
                                     and TP1CORR1 = 18
                                     and tp1corr3 = 1);--- (116, 117, 118, 119, 120, 121, 122);
            ...
            begin
              pq_cr_vidacaja.sp_cronograma(pn_emp    => pn_emp,
                                           pn_mod    => pn_mod,
                                           pn_suc    => pn_suc,
                                           pn_mda    => pn_mda,
                                           pn_pap    => pn_pap,
            ...
            case
              when ln_codVar = 1 then
                ...
                if ln_mtoprima <> ln_mtoseg then
                  begin
                    pq_cr_vidacaja.sp_cr_gracia(pn_emp    => pn_emp,
                                                pn_mod    => pn_mod,
                                                pn_suc    => pn_suc,
                                                pn_mda    => pn_mda,
                                                pn_pap    => pn_pap,
        ...
        if nvl(ln_mtoprima, 0) > 0 then
          begin
            pq_cr_vidacaja.sp_cr_validapago(ln_pgcod     => pn_emp,
                                            ln_modulo    => pn_mod,
                                            ln_sucursal  => pn_suc,
                                            ln_moneda    => pn_mda,
                                            ln_papel     => pn_pap,
  ...
  begin
    begin
      ...
      for i in creditos loop
        ...
        PQ_CR_VIDACAJA.Sp_monto_calendarioVC(i.JAQZ085EMP,
                                             i.JAQZ085MOD,
                                             ln_sucAct,
                                             i.JAQZ085MDA,
                                             i.JAQZ085PAP,
      ...
      pq_cr_vidacaja.sp_cr_Desafiliaciones(pd_fecpro, P_C_DIGITO);
      pq_cr_vidacaja.sp_cr_Desafilia60(P_C_DIGITO, pd_fecpro);
      ...
      if lc_variable = 'S' then
        ...
        */
        if lc_flag = 'S' and ln_monto <> 0 then
          ...
          begin
            pq_cr_vidacaja.sp_cr_inserta(ln_pgcod     => ln_pgcod,
                                         ln_modulo    => ln_modulo,
      ...
      begin
        ...
        select 'S'
         ...
         where f.pgcod = d.ln_pgcod
           ...
           and f.sgcod in ( select TP1NRO3 from  Fst198
                             Where Tp1cod   = 1
                               and Tp1cod1  = 10898
                               and TP1CORR1 = 18
                               and tp1corr3 = 1);--(116, 117, 118, 119, 120, 121, 122);
      ...
      if lc_flagExtSeg = 'N' then
        ...
        begin
          ...
          if flag_desa = 'S' then
            ...
            pq_cr_vidacaja.sp_cr_inserta(ln_pgcod     => d.ln_pgcod,
                                         ...
                                         ld_fchpago   => d.ld_fchpago,
                                         ln_imp       => d.ld_importe,
                                         ln_imp1      => d.ld_importe,
                                         ln_imp2      => 0,
                                         ln_imp3      => 0,
                                         ln_imp4      => 0,
                                         ln_imp5      => 0,
  ...
  procedure sp_cr_Desafilia60(P_C_DIGITO in varchar2, ld_fecfin in date) is
  ...
  begin
    ...
    for l in listado loop
      ...
      if lc_flagExst = 'N' then
        ...
        if ln_mntcalndario = ln_mntpagado  then

          pq_cr_vidacaja.sp_cr_inserta(ln_pgcod     => l.ln_pgcod,
          ...
          pq_cr_vidacaja.sp_cr_copiainfo(PGFAPE      => l.ld_fchpago,
                                         ln_cuenta   => l.ln_cuenta,
                                         ln_modulo   => l.ln_modulo,
                                         ln_moneda   => l.ln_moneda,
  ...
  begin
    ...
    for job in c_clientes_job loop
      ...
      lc_variable := ' begin ' || ' PQ_CR_VIDACAJA.Sp_carga_VC(''' ||
