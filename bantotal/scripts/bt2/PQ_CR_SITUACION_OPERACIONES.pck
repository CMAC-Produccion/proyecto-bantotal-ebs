CREATE OR REPLACE PACKAGE PQ_CR_SITUACION_OPERACIONES IS
  ...
  -- ACCESO                      : PUBLICO
  -- ====================================================================================================
  -- FECHA DE MODIFICACION       : 28/11/2025
  -- AUTOR DE LA MODIFICACION    : MPOSTIGOC
  -- DESCRIPCION DE MODIFICACION : Se cambio los datos de actualizacion a partir de la linea 226
  -- ====================================================================================================
...
CREATE OR REPLACE PACKAGE BODY PQ_CR_SITUACION_OPERACIONES IS
  ...
  PROCEDURE SP_CR_GRABAR_CABECERA(PI_EMPRESA    IN NUMBER,
    ...
    -- ACCESO                      : PUBLICO
    -- ====================================================================================================
    -- FECHA DE MODIFICACION       : 21/10/2025
    -- AUTOR DE LA MODIFICACION    : MPOSTIGOC
    -- DESCRIPCION DE MODIFICACION : Se cambio los datos de actualizacion a partir de la linea 226
    -- ====================================================================================================
  ...
  BEGIN
    ...
    BEGIN
      SELECT 'S', A.AQPD412INS
        INTO V_PROCESAR, V_AQPD412INS
        FROM AQPD412 A
    ...
    IF V_PROCESAR = 'S' THEN
      -- OBTENER FECHA BT --
      BEGIN
        SELECT A.PGFAPE INTO V_FECHA_BT FROM FST017 A WHERE A.PGCOD = 1;
      EXCEPTION
        WHEN OTHERS THEN
          NULL;
      END;
      ...
      BEGIN
        UPDATE AQPD412 A
           SET A.AQPD412TCUO   = V_TOT_CUOTA,
               ...
               A.AQPD412ITF    = V_ITF,
               A.AQPD412CDCM   = A.AQPD412CDCA * V_CANC_CAPITAL,
               A.AQPD412CDIM   = A.AQPD412CDINT * V_CANC_INTERES,
               A.AQPD412CDMM   = A.AQPD412CDMO * V_CANC_MORA,
               A.AQPD412CDOM   = A.AQPD412CDOT * V_CANC_GASTOS,
               A.AQPD412CDICVM = A.AQPD412CDICV * V_CANC_ICV,
               A.AQPD412CDSM   = A.AQPD412CDSE * V_CANC_SEGURO,
               A.AQPD412CDPM   = A.AQPD412CDPE * V_CANC_PENALIDAD,
               A.AQPD412CDITFM = A.AQPD412CDITF * V_CANC_ITF,
               A.AQPD412CXDC   = A.AQPD412CXDCM * V_CAPITAL,
               A.AQPD412CXDI   = A.AQPD412CXDIM * V_INTERES,
               A.AQPD412CXDM   = A.AQPD412CXDMM * V_MORA,
               A.AQPD412CXDO   = A.AQPD412CXDOM * V_GASTOS,
               A.AQPD412CXDICV = A.AQPD412CXDICVM * V_ICV,
               A.AQPD412CXDS   = A.AQPD412CXDSM * V_SEGURO,
               A.AQPD412CXDP   = A.AQPD412CXDPM * V_PENALIDAD,
               A.AQPD412CXDITF = A.AQPD412CXDITFM * V_ITF,
      ...
      BEGIN
        ...
        VALUES
          (V_CORREL,
           ...
           PI_PENALIDAD,
           PI_ITF,
           (PI_CAPITAL + PI_INTERES + PI_MORA + PI_INTC + PI_SEGURO +
           PI_PENALIDAD + PI_ITF));
        COMMIT;
      EXCEPTION
        WHEN OTHERS THEN
