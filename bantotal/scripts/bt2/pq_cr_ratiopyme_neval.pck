create or replace package PQ_CR_RATIOPYME_NEVAL is
  ...
  -- Fecha de Modificación      : 18/01/2024
  -- Autor de la Modificación   :  Maria Postigo
  -- Descripción de Modificación: Se agrego una tasa por defecto 0.000001 para los casos donde su tasa mensualizada es 0
  ...
  procedure sp_cr_DeudaIFIS(Instancia     in number,
                            ...
                            saldo_externo out number);
  ----------------------------------------------------
  procedure sp_cr_VerRepXCap(ln_pgcod10    in number,
                             ln_mod10      in number,
                             ln_suc10      in number,
                             ln_mda10      in number,
                             ln_pap10      in number,
...
end PQ_CR_RATIOPYME_NEVAL;
/

create or replace package body PQ_CR_RATIOPYME_NEVAL is
  ...
  begin
    ...
    for i in inserta loop
      ...
      PQ_CR_RATIOPYME_NEVAL.sp_refinanLinea(i.ln_pgcod10,
                                            i.ln_mod10,
                                            i.ln_suc10,
                                            i.ln_mda10,
                                            i.ln_pap10,
      ...
      PQ_CR_RATIOPYME_NEVAL.Sp_Adicional_CK(i.ln_mod10,
                                            i.ln_tope10,
                                            lc_fgAdic);
      PQ_CR_RATIOPYME_NEVAL.Sp_ampliados_CK(i.ln_pgcod10,
                                            i.ln_mod10,
                                            i.ln_suc10,
                                            i.ln_mda10,
                                            i.ln_pap10,
      ...
      PQ_CR_RATIOPYME_NEVAL.sp_cr_VerVincLinea(i.ln_mod10,
                                               i.ln_suc10,
                                               i.ln_mda10,
                                               i.ln_pap10,
                                               i.ln_cta10,
      ...
      pq_cR_ratiopyme_neval.sp_cr_VerRepXCap(ln_pgcod10    => 1,
                                             ln_mod10      => i.ln_mod10,
                                             ln_suc10      => i.ln_suc10,
                                             ln_mda10      => i.ln_mda10,
                                             ln_pap10      => i.ln_pap10,
                                             ...
                                             ln_instancia  => Instancia,
                                             lc_VerRepXCap => lc_VerRepXCap);
      if lc_VerRepXCap = 'N' then
        ln_Suboper := i.ln_sbop10;
      else
        if lc_VerRepXCap = 'S' then
          ln_SubOper := 609;
        end if;
      end if;
      ...
      if lc_fgAdic <> 'S' and lc_fgAmpl <> 'S' and lc_fgRefLin <> 'S' and
        ...
        PQ_CR_RATIOPYME_NEVAL.sp_resolutor(ln_Pepais,
                                           ln_Petdoc,
                                           ln_Pendoc,
                                           Instancia,
                                           pd_fecpro,
    ...
    for c in vuelo loop
      ...
      PQ_CR_RATIOPYME_NEVAL.Sp_Adicional_CK(c.ln_mod10,
                                            c.ln_tope10,
                                            lc_fgAdic);
    ...
    for j in lineas_ven loop
      ...
      PQ_CR_RATIOPYME_NEVAL.Sp_Adicional_CK(j.ln_mod10,
                                            j.ln_tope10,
                                            lc_fgAdic);
    
      PQ_CR_RATIOPYME_NEVAL.sp_refinanLinea(J.ln_pgcod10,
                                            J.ln_mod10,
                                            J.ln_suc10,
                                            J.ln_mda10,
                                            J.ln_pap10,
      ...
      PQ_CR_RATIOPYME_NEVAL.sp_cr_VerVincLinea(j.ln_mod10,
                                               j.ln_suc10,
                                               j.ln_mda10,
                                               j.ln_pap10,
                                               j.ln_cta10,
      ...
      if lc_ven = 'S' then
        Pq_Cr_Ratiopyme_Neval.sp_cr_VerfLVInsertada(ln_instancia  => Instancia,
                                                    lc_Estado     => lc_flgprg,
                                                    ln_pgcod117   => 1,
      ...
      if lc_ven = 'S' and lc_IsInsert = 'N' and lc_fgAdic <> 'S' and
        ...
        PQ_CR_RATIOPYME_NEVAL.sp_resolutor_venc(ln_Pepais,
                                                ln_Petdoc,
                                                ln_Pendoc,
                                                Instancia,
                                                pd_fecpro,
    ...
    begin
      ...
      PQ_CR_RATIOPYME_NEVAL.sp_cr_CuotaContinCF(Instancia,
                                                pd_fecpro,
                                                lc_flgprg,
                                                ln_MntCuoCntgCF);
    
      PQ_CR_RATIOPYME_NEVAL.sp_cr_CuotaContinAval(Instancia,
                                                  pd_fecpro,
                                                  lc_flgprg,
                                                  ln_MntCuoCntgAval);
    ...
    begin
      PQ_CR_RATIOPYME_NEVAL.sp_cr_CuotaPotencialII(Instancia,
                                                   pd_fecpro,
                                                   lc_Usuario,
                                                   ln_MntPotncial);
        ...
        select sum(j.jaqy142capcuo)
         ...
         where j.jaqy142inst = Instancia
           ...
           and j.jaqy142indic in
               ('CredVigent', 'CredVencid', 'CredVuelo', 'LineaVencd'); -- mpostigoc 26.09.2020
      exception
        when others then
          ln_captotcaja1 := 0;
      end;
    ...
    PQ_CR_RATIOPYME_NEVAL.sp_cr_DeudaIFIS(Instancia,
                                          ln_tipocambio,
                                          saldo_externo);
    ...
    saldo_externo := nvl(saldo_externo, 0) - nvl(ln_MntPotncial, 0); --mpostigoc 25.09.2020
    ...
    if Divisor <> 0 then
      ...
      ln_captotal1 := round(((ln_captotcaja + saldo_externo + ln_MntCuoCntg +
                            ln_MntPotncial) /
    ...
    PQ_CR_RATIOPYME_NEVAL.sp_cr_LogRatio(ln_Pepais      => ln_Pepais,
                                         ln_Petdoc      => ln_Petdoc,
                                         ln_Pendoc      => ln_Pendoc,
  ...
  begin
    ...
    ln_inscred := fn_instancia_credito(v_Scmod  => ln_mod10,
                                       v_Scsuc  => ln_suc10,
                                       v_Scmda  => ln_mda10,
                                       v_Scpap  => ln_pap10,
                                       v_Sccta  => ln_cta10,
    ...
    ln_inscred := nvl(ln_inscred, 0);
  
    if ln_inscred = ln_instancia then
      lc_VerRepXCap := 'S';
    else
      if ln_inscred <> ln_instancia then
        lc_VerRepXCap := 'N';
  ...
  begin
    ...
    begin
      ...
      begin
        select sum(j.aqpb081gfin)
          into saldo_extSoles
          from aqpb081 j
         where j.aqpb081inst = Instancia
           and j.aqpb081esta = 'S'
           and j.aqpb081chek = '1'
           and j.aqpb081tcre in
               ('Pymes S/.', 'Consumo S/.', 'Hipotecario S/.')
           and j.aqpb081aux3 = 'R'; -- MPOSTIGOC 04/10/18 INC1373
        --and j.aqpb081aux1 = 7; -- Tarea de Evaluacion Propuesta MPOSTIGOC 04/10/18 INC1373
      exception
        when others then
          saldo_extSoles := 0;
    ...
    if ln_pais is not null then
      ...
      for l in lista_CredVigCF(ln_pais, ln_tdoc, lc_ndoc) loop
        ...
        if ln_SaldCap > 0 then
          begin
            PQ_CR_RATIOPYME_NEVAL.sp_cr_LogCuentas(ln_pais,
                                                   ln_tdoc,
                                                   lc_ndoc,
                                                   ln_tipocambio,
                                                   ln_Instancia,
  ...
  begin
    ...
    if ln_pais is not null then
      ...
      for l in lista_CredVigAval(ln_pais, ln_tdoc, lc_ndoc) loop
        ...
        PQ_CR_RATIOPYME_NEVAL.Sp_ampliados_CK(ln_emp10  => l.ln_pgcod10,
                                              ln_mod10  => l.ln_mod10,
                                              ln_suc10  => l.ln_suc10,
                                              ln_mda10  => l.ln_mda10,
                                              ln_pap10  => l.ln_pap10,
        ...
        PQ_CR_RATIOPYME_NEVAL.sp_refinanLinea(ln_pgcod10  => l.ln_pgcod10,
                                              ln_mod10    => l.ln_mod10,
                                              ln_suc10    => l.ln_suc10,
                                              ln_mda10    => l.ln_mda10,
                                              ln_pap10    => l.ln_pap10,
        ...
        PQ_CR_RATIOPYME_NEVAL.sp_cr_VerVincLinea(ln_mod10  => l.ln_mod10,
                                                 ln_suc10  => l.ln_suc10,
                                                 ln_mda10  => l.ln_mda10,
                                                 ln_pap10  => l.ln_pap10,
                                                 ln_cta10  => l.ln_cta10,
  ...
  procedure sp_cR_CuotaPotencial(ln_Instancia   in number,
    ...
    cursor lista_lineas is
      select sum(j.AQPB081tlin) ln_LineaTotal,
             sum(j.AQPB081util) ln_LineaUtilizada
        from AQPB081 j
       where j.AQPB081inst = ln_Instancia
         and j.AQPB081esta = 'S'
         and j.AQPB081chek = '1'
         and j.AQPB081flin in ('L');
  ...
  procedure sp_cr_CuotaPotencialII(ln_Instancia   in number,
    ...
    cursor lista_LineaConsumo is
      select *
        from aqpb357 j
       where j.aqpb357inst = ln_Instancia
         and j.aqpb357esta = 'S';
  ...
  begin
    ...
    begin
      delete from jaqz823B j where j.jaqz823inst = ln_Instancia;
      commit;
    end;
    ...
    begin
      ...
      select count(*)
       ...
       where Pgcod = ln_pgcod10
         ...
         and D601co in ('S', 'X', 'E'); -- mpostigoc 26.01.21
    exception
      when others then
        null;
    end;
  ...
  begin
    ...
    ln_SNG001Ori := nvl(ln_SNG001Ori, 0); --mpostigoc 01.03.2021
  ...
  begin
    ...
    if ln_mod10 <> 117 and ln_subop10 <> 609 then
      ...
      if ln_mod10 <> 117 and ln_subop10 = 609 then
        ...
        begin
          select j.jaqa400ai3
            into ln_cuoimp
            from jaqa400 j
           where j.jaqa400emp = ln_pgcod10
             and j.jaqa400mod = ln_mod10
             and j.jaqa400suc = ln_suc10
             and j.jaqa400mda = ln_mda10
             and j.jaqa400pap = ln_pap10
             and j.jaqa400cta = ln_cta10
             and j.jaqa400ope = ln_oper10
                -- and j.jaqa400sbo = ln_subop10
             and j.jaqa400top = ln_tope10
             and j.jaqa400ai3 > 0;
        exception
          when others then
            ln_cuoimp := 0;
    ...
    begin
      select max(d.ppcap + d.ppint)
       ...
       where d.pgcod = ln_pgcod10
         ...
         and d.ppsbop = ln_subop10
         and d.pptope = ln_tope10
         and d.d601co in ('X', 'E'); -- mpostigoc 26.01.21
    exception
      when others then
        NULL;
  ...
  begin
    ...
    -- PQ_CR_RATIOPYME_NEVAL.Sp_Adicional(instancia,tipocambio,ln_mda10,ln_mtoAdic);
  ...
  begin
    ...
    PQ_CR_RATIOPYME_NEVAL.sp_cuotas(ln_pgcod10,
                                    ln_mod10,
                                    ln_suc10,
                                    ln_mda10,
                                    ln_pap10,
    ...
    PQ_CR_RATIOPYME_NEVAL.sp_instancia(ln_mod10,
                                       ln_suc10,
                                       ln_mda10,
                                       ln_pap10,
                                       ln_cta10,
    ...
    PQ_CR_RATIOPYME_NEVAL.sp_cr_flujocaja(ln_pgcod10,
                                          ln_mod10,
                                          ln_suc10,
                                          ln_mda10,
                                          ln_pap10,
    ...
    if ln_mod10 <> 117 and ln_flagFC = 'N' then
      if ln_indicador <> 2 then
        PQ_CR_RATIOPYME_NEVAL.sp_cuota_impaga(ln_pgcod10,
                                              ln_mod10,
                                              ln_suc10,
                                              ln_mda10,
                                              ln_pap10,
        ...
        PQ_CR_RATIOPYME_NEVAL.sp_cuota_impagavuelo(ln_pgcod10,
                                                   ln_mod10,
                                                   ln_suc10,
                                                   ln_mda10,
                                                   ln_pap10,
      ...
      if ln_mod10 <> 117 and ln_flagFC = 'S' then
        PQ_CR_RATIOPYME_NEVAL.sp_cr_capacidadFC(ln_mod10,
                                                ln_suc10,
                                                ln_mda10,
                                                ln_pap10,
                                                ln_cta10,
    ...
    PQ_CR_RATIOPYME_NEVAL.sp_seguro(ln_mod10,
                                    ln_suc10,
                                    ln_mda10,
                                    ln_pap10,
                                    ln_cta10,
    ...
    if ln_mod10 = 117 then
      PQ_CR_RATIOPYME_NEVAL.sp_capacidadlinea(ln_mod10,
                                              ln_suc10,
                                              ln_mda10,
                                              ln_pap10,
                                              ln_cta10,
    ...
    IF ln_parciales = 7 then
      ...
      PQ_CR_RATIOPYME_NEVAL.sp_capacidadpagoparc(ln_nrocuotas,
                                                 ln_parciales,
                                                 ln_seguro,
                                                 ln_mod10,
                                                 ln_instancia,
    ...
    if ln_mod10 <> 117 and ln_parciales <> 7 then
      ...
      PQ_CR_RATIOPYME_NEVAL.sp_capacidadpago(ln_cuotimp,
                                             ln_nrocuotas,
                                             ln_parciales,
                                             ln_peri10,
                                             ln_seguro,
    ...
    if ln_capacidad > 0 then
      ...
      PQ_CR_RATIOPYME_NEVAL.sp_cr_LogCuentas(ln_Pepais,
                                             ln_Petdoc,
                                             ln_Pendoc,
                                             tipocambio,
                                             Instancia,
  ...
  begin
    ...
    if lc_ven = 'S' then
      for i in creditos loop
        ...
        PQ_CR_RATIOPYME_NEVAL.sp_cuotas(i.ln_pgcod10,
                                        i.ln_mod10,
                                        i.ln_suc10,
                                        i.ln_mda10,
                                        i.ln_pap10,
        ...
        PQ_CR_RATIOPYME_NEVAL.sp_cuota_impaga_lin(i.ln_pgcod10,
                                                  i.ln_mod10,
                                                  i.ln_suc10,
                                                  i.ln_mda10,
                                                  i.ln_pap10,
        ...
        PQ_CR_RATIOPYME_NEVAL.sp_seguro(i.ln_mod10,
                                        i.ln_suc10,
                                        i.ln_mda10,
                                        i.ln_pap10,
                                        i.ln_cta10,
                                        ...
                                        fech_maxcuota,
                                        ln_seguro);
        PQ_CR_RATIOPYME_NEVAL.sp_capacidadpago_lin(ln_cuotimp,
                                                   ln_nrocuotas,
                                                   ln_pr116,
                                                   ln_seguro,
                                                   i.ln_mod10,
                                                   ln_capTem);
        PQ_CR_RATIOPYME_NEVAL.sp_instancia(i.ln_mod10,
                                           i.ln_suc10,
                                           i.ln_mda10,
                                           i.ln_pap10,
                                           i.ln_cta10,
  ...
  begin
    ...
    if ln_instancia <> ln_InsVinc then
    ...
    if lc_flagAmort = 'S' then
      ...
      if lc_flagAmort = 'N' then
        ...
        if ln_sbop10 <> 609 then
          ...
          if ln_sbop10 = 609 then
            --mpostigoc 26.02.2021
          
            begin
              select f.scsdo
                into ln_saldo
                from fsd011 f
               where f.SCCTA = ln_cta10
            ...
            begin
              select x.xllcantcuo, x.xllperiodo, x.xlltasap
                into ln_cuotas, ln_plazo, ln_tasa
                from x054023 x
               where x.xllpgcod = 1
                 and x.xllaomod = ln_mod10
                 and x.xllaosuc = ln_suc10
  ...
  begin
    ...
    if ln_InstME > 0 and LN_EvalME > 0 then
      lc_IndME := 'S';
    else
      lc_IndME := 'N';
    end if;
