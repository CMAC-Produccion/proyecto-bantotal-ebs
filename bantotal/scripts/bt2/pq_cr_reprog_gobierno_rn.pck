create or replace package pq_cr_reprog_gobierno_RN is

  Procedure sp_indicador(pn_ins in number, pc_ind out char);
  ...
  procedure sp_indicadorCG(pn_ins in number, pc_existe out char); --mod@abr 20201202
...
end pq_cr_reprog_gobierno_RN;
/

create or replace package body pq_cr_reprog_gobierno_RN is

  Procedure sp_indicador(pn_ins in number, pc_ind out char) is
  ...
  begin
    ...
    if lc_ind = 'H' then
      ...
      ln_plazo := (ld_fvto - pd_Fecpro) + ((ln_meses / 12) * 365) + ln_dias;
  ...
  procedure sp_indicadorCG(pn_ins in number, pc_existe out char) is
  ...
  begin
    ...
    pq_cr_reprog_gobierno_RN.sp_cr_flujocaja(ln_emp,
                                          ln_mod,
                                          ln_suc,
                                          ln_mda,
                                          ln_pap,
  ...
  begin
    ...
    ln_plazo := ((ld_fvto - pd_Fecpro)) * ( 100+ ln_inc) / 100;
