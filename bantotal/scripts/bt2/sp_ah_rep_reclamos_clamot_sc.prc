CREATE OR REPLACE PROCEDURE SP_AH_REP_RECLAMOS_CLAMOT_SC(P_USER IN VARCHAR, P_CLACOD IN NUMBER
...
, P_ERRMSG        OUT VARCHAR
  ...
  ---***
  ---******
  FOR MROW IN (SELECT * FROM JAQL422 WHERE JAQL422EST = 'S' AND JAQL422SBS BETWEEN ln_MIN_CLACOD AND ln_MAX_CLACOD)
  LOOP
  ---***
  ln_INSERT := 0;
  lc_CLADES := 0;
  ...
  ln_CODPOR_AUX := 0;
  ---***
  --DBMS_OUTPUT.PUT_LINE('ln_EST_RECIBI:= '||ln_EST_RECIBI);
  --DBMS_OUTPUT.PUT_LINE('ln_EST_PROCES:= '||ln_EST_PROCES);
  --DBMS_OUTPUT.PUT_LINE('ln_EST_RESPON:= '||ln_EST_RESPON);
  --DBMS_OUTPUT.PUT_LINE('ln_EST_ANULAD:= '||ln_EST_ANULAD);
  ---***

  FOR XROW IN
  ((SELECT J420.JAQL420COD, J422.JAQL422DES, J422.JAQL422COD, J422.JAQL422SBS, J420.JAQL420FCR, J420.JAQL420ESR
  , J420.JAQL420FCC, J420.JAQL420FLD
  FROM JAQL420 J420
  JOIN JAQL422 J422 ON (J420.JAQL420MOT = J422.JAQL422COD AND J422.JAQL422EST = 'S')
  WHERE (J422.JAQL422SBS = MROW.JAQL422SBS)
  AND (J420.JAQL420FCR BETWEEN P_FECRECIBIINI AND P_FECRECIBIFIN)
  AND (J420.JAQL420FCC BETWEEN ld_FEC_MINI AND ld_FEC_MFIN)
  AND (J420.JAQL420ESR IN (ln_EST_RECIBI, ln_EST_PROCES, ln_EST_ANULAD)))
  ...
  WHERE (J422.JAQL422SBS = MROW.JAQL422SBS)
  AND (J420.JAQL420FCR BETWEEN P_FECRECIBIINI AND P_FECRECIBIFIN)
  AND (J420.JAQL420FCC BETWEEN P_FECRESPONINI AND P_FECRESPONFIN)
  AND (J420.JAQL420ESR = ln_EST_RESPON)))

  LOOP
  ---***
  --DBMS_OUTPUT.PUT_LINE('XROW.JAQL420COD:= '||XROW.JAQL420COD);
  ---***
  ln_INSERT := 1;
  ---***
  ---*** TOTAL DE ESTE CODIGO
  lc_CLADES := XROW.JAQL422DES;
  ...
  INSERT INTO AQPB521 (AQPB521CREUSR, AQPB521CRETIM, AQPB521REPTIP, AQPB521CODIGO
    ...
    VALUES (P_USER, SYSDATE, 'M', MROW.JAQL422COD
  ...
  ---******
END SP_AH_REP_RECLAMOS_CLAMOT_SC;
/
