CREATE OR REPLACE PROCEDURE PDEPE092 (
       ...
       ain_red  IN PLS_INTEGER, -- Relacion Desde
       ain_reh  IN PLS_INTEGER, -- Relacion Hasta
       ...
       CURSOR c_fsd015 IS
              ...
              WHERE Pgcod = ain_emp and itsuc between ain_sud and ain_suh
                                    ...
                                    and itnrel between ain_red and ain_reh
              ...
              FROM fsd015 T2,
                       fsd016 T1 WHERE
                                   T1.Pgcod = ain_emp and T1.itsuc between ain_sud and ain_suh
                                                   ...
                                                   and T1.itnrel between ain_red and ain_reh
