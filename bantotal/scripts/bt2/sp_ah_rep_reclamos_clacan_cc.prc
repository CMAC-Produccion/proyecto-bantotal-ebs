CREATE OR REPLACE PROCEDURE SP_AH_REP_RECLAMOS_CLACAN_CC(P_USER IN VARCHAR, P_CLACOD IN NUMBER
...
, P_ERRMSG        OUT VARCHAR
  ...
  FOR XROW IN
  (SELECT J422C.JAQL422CDES, J420.JAQL420FCR, J420.JAQL420ESR
...
---******
END SP_AH_REP_RECLAMOS_CLACAN_CC;
/
