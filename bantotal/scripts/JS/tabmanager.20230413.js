...
// 'container' -> elemento que contendr� los leng�etas.
// 'parentManager' -> el manejador padre de �ste.
...
var ProcessTabBuilder =
{
    ...
    InitializeTab: function (li, index) {
       ...
       // li.innerHTML = "<a href='#'>Nueva Tarea</a><div class='close' title='Cerrar (F3)'></div>";
        ...
        if (index == 0 && UseStaticInitalPage == 1)
            li.innerHTML = "<a href='#'>Nueva Tarea</a><div class='' title=''></div>";
        else
            li.innerHTML = "<a href='#'>Nueva Tarea</a><div class='close' title='Cerrar (F3)'></div>";
